...
export function PublicReportApp() {
  ...
  return <main className="public-report-page"><div className="public-report-brand">▦ InfoMatt360 · Reportes</div>{message && <p role="status" className="public-report-message">{message}</p>}{report && <CatalogReportView report={report} publicView />}</main>;
}
